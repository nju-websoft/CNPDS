            ...
            for link in links:
                ...
                while not metadata:
                    try:
                        ...
                        print(f'except AttributeError: {link} ')
                        print(e)
                        break
...
if __name__ == '__main__':
    ...
    # crawler = Crawler("beijing", "beijing")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("tianjin", "tianjin")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("hebei", "hebei")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("shanxi", "datong")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("shanxi", "changzhi")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("neimenggu", "neimenggu")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("shanxi", "jincheng")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    # crawler = Crawler("shanxi", "yuncheng")
    # crawler.crawl()
    # crawler.save_matadata_as_json(METADATA_SAVE_PATH)

    crawler = Crawler("neimenggu", "xinganmeng")
    crawler.crawl()
    crawler.save_matadata_as_json(METADATA_SAVE_PATH)
